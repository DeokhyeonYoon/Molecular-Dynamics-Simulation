...
if __name__=="__main__":
    ...
    with open("finaltest_pme_topology_100ns_2.pdb", "w") as pdb_file:
    ...
    simulation.reporters.append(
        md.reporters.XTCReporter(file=str("finaltest_pme_trajectory_100ns_2.xtc"), reportInterval=write_interval)
    )
    simulation.reporters.append(
    ...
    import os
    result = "./finaltest_pme_trajectory_100ns_2.xtc"
