...
if __name__=="__main__":
    ...
    with open("240814_Final_topology_50ns_NoCutoff_2.pdb", "w") as pdb_file:
    ...
    simulation.reporters.append(
        md.reporters.XTCReporter(file=str("240814_Final_trajectory_50ns_NoCutoff_2.xtc"), reportInterval=write_interval)
    )
    simulation.reporters.append(
    ...
    import os
    result = "./240814_Final_trajectory_50ns_NoCutoff_2.xtc"
