...
if __name__=="__main__":
    ...
    with open("topology_100ns_2.pdb", "w") as pdb_file:
    ...
    simulation.reporters.append(
        md.reporters.XTCReporter(file=str("trajectory_100ns_2.xtc"), reportInterval=write_interval)
    )
    simulation.reporters.append(
