...
if __name__=="__main__":
    ...
    system = forcefield.createSystem(modeller.topology, nonbondedMethod=app.CutoffNonPeriodic, nonbondedCutoff=1.0 * unit.nanometers,)
    ...
    with open("topology_100ns_NoCutoff_middleintegrator_2.pdb", "w") as pdb_file:
    ...
    simulation.reporters.append(
        md.reporters.XTCReporter(file=str("topology_100ns_NoCutoff_middleintegrator_2.xtc"), reportInterval=write_interval)
    )
    simulation.reporters.append(
    ...
    import os
    result = "./topology_100ns_NoCutoff_middleintegrator_2.xtc"
