...
if __name__=="__main__":
    ...
    with open("finaltest_topology_100ns_8.pdb", "w") as pdb_file:
    ...
    simulation.reporters.append(
        md.reporters.XTCReporter(file=str("finaltest_trajectory_100ns_8.xtc"), reportInterval=write_interval)
    )
    simulation.reporters.append(
    ...
    import os
    result = "./finaltest_trajectory_100ns_8.xtc"
