...
if __name__=="__main__":
    ...
    with open("topology_10ns_NoCutoff_1.pdb", "w") as pdb_file:
    ...
    simulation.reporters.append(
        md.reporters.XTCReporter(file=str("trajectory_10ns_NoCutoff_1.xtc"), reportInterval=write_interval)
    )
    simulation.reporters.append(
    ...
    import os
    result = "./trajectory_10ns_NoCutoff_1.xtc"
