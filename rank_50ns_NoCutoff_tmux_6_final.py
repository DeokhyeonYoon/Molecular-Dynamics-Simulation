...
if __name__=="__main__":
    ...
    with open("Final_topology_50ns_NoCutoff_6.pdb", "w") as pdb_file:
    ...
    simulation.reporters.append(
        md.reporters.XTCReporter(file=str("Final_trajectory_50ns_NoCutoff_6.xtc"), reportInterval=write_interval)
    )
    simulation.reporters.append(
    ...
    import os
    result = "./Final_trajectory_50ns_NoCutoff_6.xtc"
